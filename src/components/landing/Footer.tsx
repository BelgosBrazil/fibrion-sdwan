      ...
      <div className="container-main px-4 md:px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-background/70 mb-6 max-w-sm">
              Infraestrutura de telecomunicações de alta performance para empresas que não podem parar.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:contato@fibrion.com.br" className="flex items-center gap-2 text-background/70 hover:text-background transition-colors">
        ...
        <div className="pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/50">
            © {currentYear} Fibrion. Todos os direitos reservados.
          </p>
